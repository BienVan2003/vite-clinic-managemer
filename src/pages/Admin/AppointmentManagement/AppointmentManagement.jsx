...
import { apiDoctorList, apiShiftList, apiAppointmentList, apiDeleteAppointment, apiServiceList, apiAddClinic, apiEditClinic } from '../../../services';
...
const AppointmentManagement = function () {
    ...
    const handleDelete = () => {
        apiDeleteAppointment(object.id)
            .then(res => {
    ...
    const fetchData = async () => {
        ...
        const res2 = await apiServiceList();
        setServices(res2.data)
        const res3 = await apiShiftList();
        setShifts(res3.data)
        const res4 = await apiDoctorList();
        setDoctors(res4.data)
    };
