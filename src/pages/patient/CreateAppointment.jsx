...
import { apiAddAppointment, apiClinicList, apiDoctorList, apiServiceList, apiShiftList, apiCheckAppointment } from "../../services";
...
const CreateAppointment = function () {
    ...
    const handleSelect = async (event) => {
        ...
        if (appointment.bookingDate !== 0 && appointment.doctorId !== 0 && appointment.shiftId !== 0) {
            apiCheckAppointment(appointment)
            .then(res => {
                if (res.status === true) {
